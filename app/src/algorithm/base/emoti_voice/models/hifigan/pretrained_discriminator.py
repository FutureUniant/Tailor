...
import torch
from app.src.algorithm.base.emoti_voice.models.hifigan.models import MultiScaleDiscriminator, MultiPeriodDiscriminator
...
class Discriminator(nn.Module):
    def __init__(self, config) -> None:
        ...
        if config.pretrained_discriminator:
            ...
            print("checkpoint discriminator is loaded")
