...
from app.src.algorithm.base.sadtalker.src.face3d.util.preprocess import align_img
from app.src.algorithm.base.sadtalker.src.face3d.util.load_mats import load_lm3d
from app.src.algorithm.base.sadtalker.src.face3d.models import networks

from scipy.io import savemat
from app.src.algorithm.base.sadtalker.src.utils.croper import Preprocesser


import warnings

from app.src.algorithm.base.sadtalker.src.utils.safetensor_helper import load_x_from_safetensor
...
class CropAndExtract:
    def __init__(self, sadtalker_path, device):
        ...
        self.propress = Preprocesser(sadtalker_path["gfpgan"], device)
    ...
    def generate(self, input_path, save_dir, crop_or_resize='crop', source_image_flag=False, pic_size=256):
        ...
        if not os.path.isfile(input_path):
            ...
            full_frames = [cv2.imdecode(np.fromfile(input_path, dtype=np.uint8), -1)]
            fps = 25
        else:
            # loader for videos
