...
class TLRImageDialog(CTkToplevel):
    ...
    def _create_widgets(self):
        ...
        self._first_frame.grid_rowconfigure((0, 1), weight=1)
        self._first_frame.grid_columnconfigure(0, weight=1)
        self._first_frame.grid_rowconfigure(2, weight=4)

        self._first_frame0 = CTkFrame(master=self._first_frame,
                                        fg_color=self._fg_color)
        self._first_frame0.grid(row=0, column=0, pady=(10, 0), sticky="nsew")
        self._first_frame0.grid_rowconfigure(0, weight=1)
        self._first_frame0.grid_columnconfigure((0, 1), weight=1)
        self._first_frame0.grid_columnconfigure(2, weight=4)

        self._path_label = CTkLabel(master=self._first_frame0,
        ...
        self._path_combobox = customtkinter.CTkComboBox(master=self._first_frame0,
                                                        width=120,
                                                        height=self._label_height,
        ...
        self._browse_button = CTkButton(master=self._first_frame0,
        ...
        self._first_frame1 = CTkFrame(master=self._first_frame,
                                           height=0,
                                           corner_radius=0,
                                           fg_color=self._fg_color
                                           )
        self._first_frame1.grid(row=1, column=0, pady=(10, 0), sticky="ew")

        self._first_frame1.grid_rowconfigure(0, weight=1)
        self._first_frame1.grid_columnconfigure((0, 1, 2, 3, 4, 5), weight=1)

        self._image_size_label = CTkLabel(master=self._first_frame1,
                                          width=80,
                                          height=self._label_height,
                                          wraplength=150,
                                          fg_color="transparent",
        ...
        self._width_entry = CTkEntry(master=self._first_frame1, width=50, height=5, corner_radius=3, border_width=1)
        ...
        self._height_entry = CTkEntry(master=self._first_frame1, width=50, height=10, corner_radius=3, border_width=1)
        ...
        self._first_image_label2 = CTkLabel(master=self._first_frame,
                                            text="",
                                            height=300,)
        self._first_image_label2.grid(row=2, column=0, pady=(10, 0), sticky="nsew")
    ...
    def _browse_event(self, event=None):
        ...
        try:
            ...
            if self._image_label_height <= 0:
                self._image_label_height = self._first_image_label2.winfo_height()
            if self._image_label_width <= 0:
                self._image_label_width = self._first_image_label2.winfo_width()
            self._show_image()
        except:
            self._image_path = ""
            self._chosen_image = None
    ...
    def _show_image(self):
        ...
        self._first_image_label2.configure(image=self._ctk_chosen_image)
    ...
    def _ok_event(self, event=None):
        image_path = self._path_combobox.get()
    ...
    def get_image_text(self):
        ...
        return {
            ...
            "size": (int(self._width_entry.get()), int(self._height_entry.get())),
        }
